  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="absolute inset-y-0 right-0 z-[115] flex w-full max-w-sm flex-col border-l border-neon-cyan/30 bg-black shadow-[-8px_0_24px_rgba(0,0,0,0.5)]"
      >
        {/* Header */}
        ...
        <div className="min-h-0 flex-1 space-y-3 overflow-y-auto px-3 py-3">
          {threadMessages.length === 0 ? (
            <p className="text-center font-mono text-[9px] text-zinc-600 py-6">{t('thread.noReplies')}</p>
          ) : (
                ...
                >
                  ...
                  <div className={`max-w-[85%] border px-2.5 py-1.5 font-mono text-[10px] ${
                    mine
                      ...
                      : 'border-neon-cyan/20 bg-black text-neon-red'
                  }`}>
                    {m.plaintext && (
