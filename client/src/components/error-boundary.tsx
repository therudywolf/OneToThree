...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="fixed inset-0 z-[500] flex flex-col items-center justify-center bg-void px-6 font-mono selection:bg-neon-red selection:text-text-primary">
        <div className="pointer-events-none absolute inset-0 z-0 opacity-[0.05] bg-[url('/noise.svg')]" />

        <div className="relative z-10 w-full max-w-md border border-border-strong bg-void p-8 shadow-[0_0_60px_rgba(255,0,0,0.1)]">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="group relative w-full border border-border-strong bg-void py-3 text-[10px] uppercase tracking-[0.3em] text-text-muted transition-all hover:border-neon-cyan hover:text-neon-cyan"
            >
