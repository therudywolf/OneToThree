...
describe('Safety numbers', () => {
  it('produces a 60-digit grouped number that is order-independent', () => {
    ...
    const numberAB = computeSafetyNumber(a.exchange.publicKey, b.exchange.publicKey)
    const numberBA = computeSafetyNumber(b.exchange.publicKey, a.exchange.publicKey)
  ...
  it('differs when either identity is replaced', () => {
    ...
    const ab = computeSafetyNumber(a.exchange.publicKey, b.exchange.publicKey)
    const ac = computeSafetyNumber(a.exchange.publicKey, c.exchange.publicKey)
