const en = {
  ...
  'login.qrShowReceived': 'Encrypted vault received. Enter your username and vault password above to finish signing in.',
  'login.qrShowExpired': 'The code expired. Generate a new one.',
  ...
  'settings.linkDeviceHint': 'Linking sends your encrypted vault straight to the new device. The vault password is still required there.',
  'settings.linkScanHint': 'Scan the QR code shown on the new device.',
  'settings.linkReauthLabel': 'Confirm your vault password to link a new device.',
  'settings.linkDone': 'Encrypted vault sent. Finish signing in on the new device.',
  'settings.linkModeScan': 'Scan QR',
  'settings.linkModeShow': 'Show QR',
  'settings.linkShowHint': 'On the new device, choose "Scan QR" on the sign-in screen and point its camera at this code.',
  'settings.linkShowWaiting': 'Waiting for the new device to scan this code...',
  'settings.linkVerifyTitle': 'Verify the code',
  'settings.linkVerifyInstruction': 'Confirm this code is identical to the one shown on the new device.',
  'settings.linkVerifyWarning': 'Only continue if the codes match exactly. A different code means another device is trying to link — cancel instead.',
  'settings.linkConfirmCta': 'Codes match — send vault',
  'settings.linkSending': 'Sending encrypted vault...',
  'settings.linkShowFailed': 'Linking failed. Generate a fresh code and try again.',
