const en = {
  ...
  'call.removedByHost': 'You were removed from the call',
  'call.removedByHostBody': 'A chat admin ended your participation in this call.',
  'call.removeFromCall': 'Remove from call',
  'call.removeFromCallConfirm': 'Remove {name} from the call?',
  'call.removeFromCallFailed': 'Could not remove the participant',
  'call.removeFromCallForbidden': 'Not enough rights to remove this participant',
  ...
  'call.connectionQuality': 'Connection quality',
  'meet.layoutGrid': 'Grid',
  'meet.layoutSpotlight': 'Spotlight',
  'meet.participantsPanel': 'Participants',
  'call.openChat': 'Chat',
  ...
  'login.keyStringPaste': 'Paste the key string from your password manager',
  'login.keyStringHint': 'It starts with otk1. — the one you saved in 1Password, Bitwarden, KeePass or a note next to your password.',
  'login.keyStringApply': 'Use this key',
  'login.keyStringInvalid': 'This does not look like a OneToThree key string (it starts with otk1.).',
  'login.keyStringTooNew': 'This key was made by a newer version of the app. Update the app.',
  'login.passkeyLogin': 'Sign in with a passkey token',
  'login.passkeyNeedsPassword': 'Enter your password above first: it will protect the key on this device.',
  'login.noLocalVaultOptPasskey': 'use your passkey token (in 1Password, Bitwarden, iCloud or a YubiKey) if you added one in Settings;',
  'passkey.title': 'Passkey token',
  'passkey.hint': 'The account key is sealed under a passkey — in 1Password, Bitwarden, iCloud Keychain or a YubiKey. On a new device, confirm the passkey and enter your password. The server stores only ciphertext.',
  'passkey.add': 'Add a passkey token',
  'passkey.enrolled': 'Done: the passkey token is set. You can now sign in on a new device with it.',
  'passkey.none': 'No passkey tokens yet.',
  'passkey.unnamed': 'Passkey',
  'passkey.removeConfirm': 'Remove this passkey token? It will no longer sign you in; the local key and the recovery phrase are untouched.',
  'passkey.errUnsupported': 'This browser does not support passkeys with the PRF extension. Chrome 116+, Safari 18+ or Firefox 135+ on the website (not the app) do.',
  'passkey.errPrf': 'This password manager or key does not support PRF. 1Password, Bitwarden, iCloud Keychain, Google Password Manager and YubiKey 5 do.',
  'passkey.errCancelled': 'The passkey operation was cancelled.',
  'passkey.errNoCredential': 'There is no passkey token for this account. Add one in Settings on a device where you are signed in.',
  'passkey.errUnseal': 'This passkey does not match the stored key. Try another passkey or another way in.',
  'passkey.errServer': 'Could not reach the server. Try again.',
  'passkey.errServerOff': 'Passkeys are not configured on this server (no https origin in CORS_ORIGIN).',
  'login.noLocalVaultExplain': 'The account @{handle} exists, but this device does not hold its key. The password alone cannot help: the key never leaves your devices. Bring it here one of these ways:',
  'login.noLocalVaultOptKeyString': 'paste the key string from your password manager (button below);',
  'login.noLocalVaultOptFile': 'open the key backup file;',
  'login.noLocalVaultOptLink': 'add this device from a phone or computer where you are already signed in (“Add a device” below);',
  'login.noLocalVaultOptRecovery': 'or sign in with your recovery phrase.',
  ...
  'postRegister.copyKey': 'Copy key string',
  'postRegister.copyKeyDone': 'Copied — paste it into your password manager',
  'postRegister.copyKeyHint': 'No USB stick around? Paste the key string into 1Password, Bitwarden or KeePass next to your password — on a new device it is all you need to sign in.',
  ...
  'settings.copyKeyStringHint': 'The same key as one line — for a field in 1Password, Bitwarden, KeePass or a note next to your password. On a new device, paste it on the sign-in screen.',
  'settings.copyKeyStringAction': 'Copy key string',
  'settings.copyKeyStringDone': 'Copied — paste it into your password manager',
  ...
  'gs.signedInAs': 'Signed in as {name}',
  'gs.joinAsAccount': 'As myself',
  'gs.joinAnonymously': 'Anonymously',
  'gs.openChatAsAccount': 'Open the chat as {name}',
  'gs.openChatAsAccountHint': 'No temporary account: an ordinary private chat that stays with both of you.',
  'gs.orCreateTempAccount': 'Or join anonymously — a temporary account is created that lives only in this tab.',
  'gs.enterAsMeFailed': 'Could not open the chat under your account. Try joining anonymously.',
