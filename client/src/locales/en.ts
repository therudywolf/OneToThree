const en = {
  ...
  'settings.recoveryTotpStepUp': 'Current 2FA code',
  ...
  'settings.recoveryDisableWarn': 'This deletes your recovery phrase on the server. The phrase you saved will stop working.',
