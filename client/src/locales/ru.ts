...
Это частный сервис, который работает «как есть». Вы сами отвечаете за свои данные и за то, как пользуетесь сервисом. Аккаунты, нарушающие правила, могут быть удалены.`,
  ...
  'login.vaultPasswordExplain1': 'Этот пароль защищает ваш аккаунт на этом устройстве.',
  'login.vaultPasswordExplain2': 'Мы его не видим и не можем сбросить — сохраните его в надёжном месте.',
