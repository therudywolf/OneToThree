const ru = {
  ...
  'settings.recoveryTotpStepUp': 'Текущий код 2FA',
  ...
  'settings.recoveryDisableWarn': 'Это удалит вашу фразу восстановления на сервере. Сохранённая фраза перестанет работать.',
