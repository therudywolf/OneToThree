const ru = {
  ...
  'login.qrShowReceived': 'Зашифрованный vault получен. Введите имя пользователя и пароль vault выше, чтобы завершить вход.',
  'login.qrShowExpired': 'Код истёк. Сгенерируйте новый.',
...
Это частный сервис, который работает «как есть». Вы сами отвечаете за свои данные и за то, как пользуетесь сервисом. Аккаунты, нарушающие правила, могут быть удалены.`,
  ...
  'settings.linkDeviceHint': 'Привязка отправит зашифрованный vault напрямую на новое устройство. Пароль vault всё равно понадобится там.',
  'settings.linkScanHint': 'Отсканируйте QR-код, показанный на новом устройстве.',
  'settings.linkReauthLabel': 'Подтвердите пароль vault, чтобы привязать новое устройство.',
  'settings.linkDone': 'Зашифрованный vault отправлен. Завершите вход на новом устройстве.',
  'settings.linkModeScan': 'Сканировать QR',
  'settings.linkModeShow': 'Показать QR',
  'settings.linkShowHint': 'На новом устройстве выберите «Сканировать QR» на экране входа и наведите камеру на этот код.',
  'settings.linkShowWaiting': 'Ожидание сканирования кода новым устройством...',
  'settings.linkVerifyTitle': 'Проверьте код',
  'settings.linkVerifyInstruction': 'Убедитесь, что этот код полностью совпадает с кодом на новом устройстве.',
  'settings.linkVerifyWarning': 'Продолжайте, только если коды совпадают в точности. Другой код означает, что привязаться пытается чужое устройство — отмените операцию.',
  'settings.linkConfirmCta': 'Коды совпадают — отправить vault',
  'settings.linkSending': 'Отправка зашифрованного vault...',
  'settings.linkShowFailed': 'Не удалось привязать. Сгенерируйте новый код и попробуйте снова.',
