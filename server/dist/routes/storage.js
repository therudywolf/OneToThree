...
import { createS3Client, ensureBucketExists, getBucketName, presignGetObject, presignPutObject, } from '../lib/s3.js';
/** Object key: chats/{chatId}/{userId}/{uuid}{ext} */
const CHAT_OBJECT_KEY_RE = /^chats\/([0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12})\/[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}\/[^/]+$/i;
...
export const storageRoutes = async (app) => {
